...
struct RequestResult : public IResult
{
	RequestResult() { type = (DWORD)ResultType::REQUEST; }
...
struct AnotherResult : public IResult
{
	AnotherResult() { type = (DWORD)ResultType::ANOTHER; }
